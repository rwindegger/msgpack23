...
namespace msgpack23 {
    ...
    template<
        ...
        std::enable_if_t<detail::is_packable_object<PackableObject>{}, int>  = 0
    >
    [[nodiscard]] std::vector<std::byte> pack(PackableObject const &obj) {
        detail::Packer packer;
    ...
    template<
        ...
        std::enable_if_t<detail::is_unpackable_object<UnpackableObject>{}, int>  = 0
    >
    [[nodiscard]] UnpackableObject unpack(std::byte const *data_start, size_t const size) {
        UnpackableObject obj{};
        detail::Unpacker unpacker{data_start, size};
        obj.unpack(unpacker);
        return obj;
    }
